...
import java.util.Set;
 ...
 /**
 * Base Pojo object for domain model class Riskcategory
 * @see es.sm2.openppm.core.model.base.Riskcategory
 * @author Hibernate Generator by Javier Hernandez
 * For implement your own methods use class Riskcategory
 */
public class BaseRiskcategory  implements java.io.Serializable {


	private static final long serialVersionUID = 1L;
	
	public static final String ENTITY = "riskcategory";
    ...
    public BaseRiskcategory() {
    }
    
    public BaseRiskcategory(Integer idRiskcategory) {
	...
	public boolean equals(Object other) {
		boolean result = false;
		 ...
		 else if (!(other instanceof Riskcategory) )  { result = false; }
		 else if (other != null) {
		 	Riskcategory castOther = (Riskcategory) other;
			if (castOther.getIdRiskcategory().equals(this.getIdRiskcategory())) { result = true; }
         }
		 return result;
   }
