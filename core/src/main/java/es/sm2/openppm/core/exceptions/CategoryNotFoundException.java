 ...
 */
public final class CategoryNotFoundException extends LogicException{

	/**
	* CategoryNotFoundException is a LogicException class
	*/
	...
	*/
	...
	public CategoryNotFoundException() {
		super("msg.error.notfound.category");
	}	
