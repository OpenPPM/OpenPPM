 ...
 *
 * Module: core
 * File: InitTabAction.java
 * Create User: jordi.ripoll
 * Create Date: 30/06/2015 12:28:05
 */
 ...
 */
public enum InitTabAction implements SecurityAction {

    JX_DELETE_PROJECT_TECHNOLOGY(new SecurityContainer(Constants.ROLE_PMO, Constants.ROLE_PM)),
    JX_SAVE_PROJECT_TECHNOLOGIES(new SecurityContainer(Constants.ROLE_PMO, Constants.ROLE_PM)),
    JX_SEARCH_TECHNOLOGY(new SecurityContainer(Constants.ROLE_PMO, Constants.ROLE_PM));

    private List<SecurityContainer> securityContainers;


    InitTabAction(SecurityContainer... securityContainers) {
