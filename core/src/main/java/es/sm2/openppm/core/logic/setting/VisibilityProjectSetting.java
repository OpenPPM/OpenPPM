 ...
 */
public enum VisibilityProjectSetting implements GenericSetting {

    PROJECT_COLUMN_CATEGORY("false"),
    PROJECT_COLUMN_CLASSIFICATION_LEVEL("false"),
    PROJECT_COLUMN_IDPROJECT("false"),
    PROJECT_COLUMN_STAGEGATE("false"),
    PROJECT_COLUMN_DURATION("false"),
    PROJECT_COLUMN_PROGRAM("false");

    private String defaultValue;
    private TypeSetting typeSetting;

    private VisibilityProjectSetting(String defaultValue) {
