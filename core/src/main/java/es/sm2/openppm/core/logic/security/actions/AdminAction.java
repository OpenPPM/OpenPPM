 ...
 */
public enum AdminAction implements SecurityAction {

    SAVE_CUSTOMIZATION(new SecurityContainer(Constants.ROLE_ADMIN)),
    JX_UPDATE_POC_PROJECTS(new SecurityContainer(Constants.ROLE_ADMIN)),
    MIGRATION_DOCUMENTS(new SecurityContainer(Constants.ROLE_ADMIN));


    private List<SecurityContainer> securityContainers;


    AdminAction(SecurityContainer... securityContainers) {
