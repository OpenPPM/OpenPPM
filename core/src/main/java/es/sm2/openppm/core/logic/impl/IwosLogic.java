...
public class IwosLogic extends AbstractGenericLogic<Iwo, Integer> {
	 ...
	 * @throws Exception 
	 */
	public List<Iwo> consIwos (Project project) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public Iwo consIwo (Integer idIwo) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public void saveIwo (Iwo iwo, Date iwoDate) throws Exception {
