 ...
 *
 * Module: core
 * File: LearnedLessonTabAction.java
 * Create User: jordi.ripoll
 * Create Date: 09/09/2015 08:36:39
 */
 ...
 */
public enum LearnedLessonTabAction implements SecurityAction {

    LEARNED_LESSON(new SecurityContainer(Constants.ROLE_PMO, Constants.ROLE_PM, Constants.ROLE_PROGM));

    private List<SecurityContainer> securityContainers;

    LearnedLessonTabAction(SecurityContainer... securityContainers) {
