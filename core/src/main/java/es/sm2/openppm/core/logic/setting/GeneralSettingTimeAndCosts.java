 ...
 */
public enum GeneralSettingTimeAndCosts implements GenericSetting {

    SUMMATION_EFFORT(Boolean.FALSE.toString()),
    POC_EXCLUDE_CA_NO_BUDGET(Boolean.FALSE.toString()),
    SHIFT_DATES_WHEN_MODIFY_BASELINE(Boolean.FALSE.toString());

    private String defaultValue;
    private TypeSetting typeSetting;

    private GeneralSettingTimeAndCosts(String defaultValue) {
        this.defaultValue 	= defaultValue;
    }

    private GeneralSettingTimeAndCosts(String defaultValue, TypeSetting typeSetting) {
        this.defaultValue 	= defaultValue;
