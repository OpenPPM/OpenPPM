...
public class ActivityAudit {
     ...
     private List<MilestonAudit> milestones = new ArrayList<MilestonAudit>();

    public ActivityAudit(Projectactivity activity) {
    	...
    	if (activity.getMilestoneses() != null && !activity.getMilestoneses().isEmpty()) {
    		...
    		for (Milestones mileston : activity.getMilestoneses()) {
    			getMilestones().add(new MilestonAudit(mileston));
    		}
    	}
    }
	 ...
	 */
	public List<MilestonAudit> getMilestones() {
		return milestones;
	}
	 ...
	 */
	public void setMilestones(List<MilestonAudit> milestones) {
