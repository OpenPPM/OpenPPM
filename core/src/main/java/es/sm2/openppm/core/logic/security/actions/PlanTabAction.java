 ...
 */
public enum PlanTabAction implements SecurityAction {

    JX_CREATE_FOLLOWUPS(new SecurityContainer(Constants.ROLE_PMO, Constants.ROLE_PM));

    private List<SecurityContainer> securityContainers;


    PlanTabAction(SecurityContainer... securityContainers) {
