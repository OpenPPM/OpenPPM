 ...
 *
 * Module: front
 * File: CustomerTypeActionImpl.java
 * Create User: javier.hernandez
 * Create Date: 21/09/2015 11:58:34
 */

package es.sm2.openppm.api.impl.maintenance;

import es.sm2.openppm.api.converter.maintenance.CustomerTypeDTOConverter;
 ...
 */
public class CustomerTypeActionImpl implements MaintenanceAction {
    ...
    public Response findAll(Company company, Employee user) {
        ...
        try {
            // Find data
            CustomertypeLogic logic = new CustomertypeLogic();
            List<Customertype> items = logic.findByRelation(Contracttype.COMPANY, company, Customertype.NAME, Order.ASC);

            // Convert to DTO and Send data
            CustomerTypeDTOConverter converter = new CustomerTypeDTOConverter();
