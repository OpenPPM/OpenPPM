 ...
 *
 * Module: front
 * File: ClassificationLevelActionImpl.java
 * Create User: javier.hernandez
 * Create Date: 21/09/2015 11:59:19
 */

package es.sm2.openppm.api.impl.maintenance;

import es.sm2.openppm.api.converter.maintenance.ClassificationLevelDTOConverter;
 ...
 */
public class ClassificationLevelActionImpl implements MaintenanceAction {
    ...
    public Response findAll(Company company, Employee user) {
        ...
        try {
            // Find data
            ClassificationlevelLogic logic = new ClassificationlevelLogic();
            List<Classificationlevel> items = logic.findByRelation(Contracttype.COMPANY, company, Classificationlevel.NAME, Order.ASC);

            // Convert to DTO and Send data
            ClassificationLevelDTOConverter converter = new ClassificationLevelDTOConverter();
