 ...
 *
 * Module: front
 * File: SkillActionImpl.java
 * Create User: javier.hernandez
 * Create Date: 25/09/2015 12:51:09
 */

package es.sm2.openppm.api.impl.maintenance;

import es.sm2.openppm.api.converter.maintenance.SkillDTOConverter;
 ...
 */
public class SkillActionImpl implements MaintenanceAction {
    ...
    public Response findAll(Company company, Employee user) {
        ...
        try {
            // Find data
            SkillLogic logic = new SkillLogic();
            List<Skill> items = logic.findByRelation(Contracttype.COMPANY, company, Skill.NAME, Order.ASC);

            // Convert to DTO and Send data
            SkillDTOConverter converter = new SkillDTOConverter();
