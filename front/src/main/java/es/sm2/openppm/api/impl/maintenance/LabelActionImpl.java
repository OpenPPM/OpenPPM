 ...
 *
 * Module: front
 * File: LabelActionImpl.java
 * Create User: javier.hernandez
 * Create Date: 21/09/2015 11:59:04
 */

package es.sm2.openppm.api.impl.maintenance;

import es.sm2.openppm.api.converter.maintenance.LabelDTOConverter;
 ...
 */
public class LabelActionImpl implements MaintenanceAction {
    ...
    public Response findAll(Company company, Employee user) {
        ...
        try {
            ...
            List<Label> items = logic.findByRelation(Contracttype.COMPANY, company, Label.NAME, Order.ASC);

            // Convert to DTO and Send data
            LabelDTOConverter converter = new LabelDTOConverter();
