 ...
 *
 * Module: front
 * File: StageGateActionImpl.java
 * Create User: javier.hernandez
 * Create Date: 21/09/2015 11:59:10
 */

package es.sm2.openppm.api.impl.maintenance;

import es.sm2.openppm.api.converter.maintenance.StageGateDTOConverter;
 ...
 */
public class StageGateActionImpl implements MaintenanceAction {
    ...
    public Response findAll(Company company, Employee user) {
        ...
        try {
            // Find data
            StagegateLogic logic = new StagegateLogic();
            List<Stagegate> items = logic.findByRelation(Contracttype.COMPANY, company, Stagegate.NAME, Order.ASC);

            // Convert to DTO and Send data
            StageGateDTOConverter converter = new StageGateDTOConverter();
