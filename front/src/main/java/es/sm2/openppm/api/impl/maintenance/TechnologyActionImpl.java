 ...
 *
 * Module: front
 * File: TechnologyActionImpl.java
 * Create User: javier.hernandez
 * Create Date: 21/09/2015 11:59:27
 */

package es.sm2.openppm.api.impl.maintenance;

import es.sm2.openppm.api.converter.maintenance.TechnologyDTOConverter;
 ...
 */
public class TechnologyActionImpl implements MaintenanceAction {
    ...
    public Response findAll(Company company, Employee user) {
        ...
        try {
            // Find data
            TechnologyLogic logic = new TechnologyLogic();
            List<Technology> items = logic.findByRelation(Contracttype.COMPANY, company, Technology.NAME, Order.ASC);

            // Convert to DTO and Send data
            TechnologyDTOConverter converter = new TechnologyDTOConverter();
