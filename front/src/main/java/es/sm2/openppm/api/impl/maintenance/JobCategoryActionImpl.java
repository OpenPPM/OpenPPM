 ...
 *
 * Module: front
 * File: JobCategoryActionImpl.java
 * Create User: javier.hernandez
 * Create Date: 25/09/2015 12:51:20
 */

package es.sm2.openppm.api.impl.maintenance;

import es.sm2.openppm.api.converter.maintenance.JobCategoryDTOConverter;
 ...
 */
public class JobCategoryActionImpl implements MaintenanceAction {
    ...
    public Response findAll(Company company, Employee user) {
        ...
        try {
            // Find data
            JobcategoryLogic logic = new JobcategoryLogic();
            List<Jobcategory> items = logic.findByRelation(Contracttype.COMPANY, company, Jobcategory.NAME, Order.ASC);

            // Convert to DTO and Send data
            JobCategoryDTOConverter converter = new JobCategoryDTOConverter();
