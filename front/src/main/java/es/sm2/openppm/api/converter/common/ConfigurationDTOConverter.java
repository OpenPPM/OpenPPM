 ...
 */
public class ConfigurationDTOConverter extends AbstractConverter<ConfigurationDTO, Setting> {
     ...
     */
    @Override
    public ConfigurationDTO toDTO(Setting model) {

        return new ConfigurationDTO(model.getName(), model.getValue());
    }
     ...
     */
    @Override
    public Setting toModel(ConfigurationDTO modelDTO) {

        Setting setting = new Setting();
        setting.setName(modelDTO.getKey());
        setting.setValue(modelDTO.getValue());
