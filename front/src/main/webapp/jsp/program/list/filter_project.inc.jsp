...
<fieldset style="margin-bottom: 15px; padding-top:10px; ">
	...
	<table width="100%" class="center hide" id="advancedFilter">
		...
		<tr>
			<th style="width: 20%"><fmt:message key="rag" /></th>
			<th style="width: 20%"><fmt:message key="project.internal"/></th>
			<th style="width: 20%"><fmt:message key="proposal.requires_travelling"/></th>
			<th style="width: 20%"><fmt:message key="funding_source"/></th>
		</tr>
		<tr>
			<td>
