...
public class WbsnodeSync {
	...
	private ActivitySync activity;
	private List<ChecklistSync> checklists = new ArrayList<ChecklistSync>();

	public WbsnodeSync(Wbsnode wbsnode) {
		...
		if (wbsnode.getProjectactivities() != null
			...
			for (Projectactivity activity : wbsnode.getProjectactivities()) {
				setActivity(new ActivitySync(activity));
			}
		}
		...
		if (wbsnode.getChecklists() != null
			...
			for (Checklist checklist : wbsnode.getChecklists()) {
				getChecklists().add(new ChecklistSync(checklist));
			}
	 ...
	 * @return the activity
	 */
	public ActivitySync getActivity() {
		return activity;
	}
	 ...
	 *            the activity to set
	 */
	public void setActivity(ActivitySync activity) {
	 ...
	 */
	public List<ChecklistSync> getChecklists() {
		return checklists;
	}
	 ...
	 */
	public void setChecklists(List<ChecklistSync> checklists) {
