...
public class AssumptionSync {
	...
	private List<AssumptionlogSync> assumptionlogs = new ArrayList<AssumptionlogSync>();

	public AssumptionSync(Assumptionregister assumption) {
		...
		if (assumption.getAssumptionreassessmentlogs() != null && !assumption.getAssumptionreassessmentlogs().isEmpty()) {
			...
			for (Assumptionreassessmentlog assumptionlog : assumption.getAssumptionreassessmentlogs()) {
				...
				getAssumptionlogs().add(new AssumptionlogSync(assumptionlog));
			}
		}
	}
	 ...
	 */
	public List<AssumptionlogSync> getAssumptionlogs() {
	 ...
	 */
	public void setAssumptionlogs(List<AssumptionlogSync> assumptionlogs) {
